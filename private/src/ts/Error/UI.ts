export function ShowUI(url: string) {
  const div: JQuery<HTMLDivElement> = $(".errorMsgLogin");
  ...
  switch (url) {
    ...
    case "passwordIncorrect":
      ...
      p.text(
        "La contraseña no coincide. Por favor, introduzca la contraseña correcta."
      );
      clearUrl(div);
      break;
    case "23000":
...
function clearUrl(div: JQuery<HTMLDivElement>) {
  setTimeout(() => {
